...
const ITEMS = [
  { id: "about",    label: "ABOUT ME",      path: "about",      fontSize: 80, offsetX: 0,  offsetY: 0,  skew: -6,  skewY: 10  },
  { id: "resume",   label: "RESUME",        path: "resume",     fontSize: 66, offsetX: 20, offsetY: 8,  skew: -11, skewY: -10 },
  { id: "github",   label: "GITHUB LINK",   path: "https://github.com/gledilami", fontSize: 68, offsetX: 8, offsetY: 6,  skew: 0, skewY: -4  },
  { id: "socials",  label: "SOCIALS",       path: "socials",    fontSize: 74, offsetX: 16, offsetY: 8,  skew: -3,  skewY: 5   },
  { id: "sideproj", label: "SIDE PROJECTS", path: "sideproj",   fontSize: 56, offsetX: 10, offsetY: 6,  skew: -4,  skewY: 7   },
];
...
export default function P3Menu({ onNavigate }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter")     handleNavigation(ITEMS[active].path);
    };
