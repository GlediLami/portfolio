...
import bgAudio from "./assets/goingdown.mp3";
...
const REVEAL_CONTENT = [
  {
    upper: ["Name: Gledis Lami", "Origin: Tirana, Albania", "Base: Heilbronn, Germany"],
    lower: ["MSc Information Engineering @ TUM", "Backend Specialist"],
  },
  {
    upper: [
      "MSc Information Engineering - TUM (2025 - Ongoing)",
      "BSc Computer Engineering - PUT Tirana (2021 - 2024)",
      "Bachelor's Thesis: AI-Driven E-mail Classification",
    ],
    lower: ["Focus: High Performance Computing", "& Distributed Systems"],
  },
  {
    upper: [
      "TUM: Teaching Assistant - GPU Computing (CUDA)",
...
const ITEMS = [
  {
    id: "twitch", label: "ABOUT ME", handle: "@gledislami", href: "https://github.com/gledilami", icon: "👤", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
    links: ["github.com/gledilami"],
    stats: [
      { tag: "LOC", value: "HEI", color: "#9147ff" },
      { tag: "AGE", value: "20+", color: "#bf94ff" },
    ],
  },
  {
    id: "instagram", label: "EDUCATION", handle: "@gledislami", href: "https://www.tum.de", icon: "🎓", barIcon: icon2, bars: 2, newBars: [1], counts: ["1.2M", "850K"],
    links: ["tum.de/study/msc", "put.edu.al/bsc"],
    stats: [
      { tag: "UNI", value: "TUM", color: "#e1306c" },
      { tag: "DEG", value: "2", color: "#f77737" },
    ],
  },
  {
    id: "tiktok", label: "EXPERIENCE", handle: "@gledislami", href: "https://github.com/", icon: "💼", barIcon: icon3, bars: 4, newBars: [0, 2], counts: ["2.1M", "1.7M", "930K", "412K"],
    links: ["facilization.com/careers", "sda.al/trainer", "tum.de/assistant", "tct.al/teaching"],
    stats: [
      { tag: "YRS", value: "2.5", color: "#00f2ea" },
      { tag: "RLS", value: "04", color: "#ff0050" },
    ],
  },
];
...
export default function AboutMe() {
  ...
  return (
    <div id="menu-screen">
      ...
      <audio ref={registerVideo} src={bgAudio} autoPlay loop muted playsInline />
      ...
      {revealed && (
        <div key={`panel-${active}`} className={`sc-reveal-panel${mounted ? " mounted" : ""}`}>
          ...
          <div className="sc-reveal-lower-bar">
            {REVEAL_CONTENT[active].lower.map((line, idx) => (
              <div key={idx} className="sc-reveal-lower-line">{line}</div>
            ))}
          </div>
        </div>
      )}
