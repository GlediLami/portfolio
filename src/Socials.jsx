...
const ITEMS = [
  {
    id: "github", label: "GITHUB", handle: "@gledislami", href: "https://github.com/gledilami", icon: "💻", barIcon: icon1, bars: 1, newBars: [0], counts: ["0"],
    links: ["github.com/gledilami"],
    stats: [
      { tag: "REP", value: "15", color: "#9147ff" },
      { tag: "STR", value: "04", color: "#bf94ff" },
    ],
  },
  {
    id: "email", label: "EMAIL", handle: "gledislami2025@...", href: "mailto:gledislami2025@gmail.com", icon: "✉️", barIcon: icon2, bars: 1, newBars: [0], counts: ["1"],
    links: ["mailto:gledislami2025@gmail.com"],
    stats: [
      { tag: "MSG", value: "New", color: "#e1306c" },
      { tag: "BOX", value: "01", color: "#f77737" },
    ],
  },
  {
    id: "contact", label: "PHONE", handle: "+4915238527140", href: "tel:+4915238527140", icon: "📞", barIcon: icon3, bars: 1, newBars: [], counts: ["2"],
    links: ["tel:+4915238527140"],
    stats: [
      { tag: "CAL", value: "Now", color: "#00f2ea" },
      { tag: "NUM", value: "49+", color: "#ff0050" },
    ],
  },
];
...
export default function Socials() {
    ...
    const onKey = (e) => {
      if (focus === "left") {
        ...
        if (e.key === "Enter") {
          ...
          const fullLink = href.startsWith("mailto:") || href.startsWith("tel:") || href.startsWith("http")
            ? href
            : "https://" + href;
        ...
        if (e.key === "Enter") {
          const link = ITEMS[active].links[activeInfoBar];
          const fullLink = link.startsWith("mailto:") || link.startsWith("tel:") || link.startsWith("http")
            ? link
            : "https://" + link;
          window.open(fullLink, "_blank");
        }
  ...
  return (
    <div id="menu-screen">
      <video ref={videoRef} src={bgVideo} autoPlay loop muted playsInline />
      <button
        tabIndex="-1"
      ...
      {mounted && Array.from({ length: ITEMS[active].links.length }).map((_, i) => (
        <div
